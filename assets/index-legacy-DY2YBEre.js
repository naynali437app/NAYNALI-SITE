    ...
    return {
      execute: function () {
        ...
        const Icon = reactExports.forwardRef(({
          ...
          iconNode,
          ...rest
        }, ref) => reactExports.createElement("svg", {
          ref,
          ...defaultAttributes,
          width: size,
          height: size,
        ...
        const createLucideIcon = (iconName, iconNode) => {
          const Component = reactExports.forwardRef(({
            className,
            ...props
          }, ref) => reactExports.createElement(Icon, {
            ref,
            iconNode,
        ...
        const initialMenuData = [{
          ...
          id: "sa1",
          name: "Croissant de jamón o atún",
          price: 70,
          category: "Sándwich"
        }, {
          id: "sa2",
          name: "Baguette de jamón o atún",
          price: 70,
          category: "Sándwich"
        }, {
          id: "sa3",
          name: "Pan blanco de jamón o atún",
          price: 60,
          category: "Sándwich"
        }, {
          id: "sa4",
          name: "Pan integral de jamón o atún",
          price: 60,
          category: "Sándwich"
        }, {
          id: "h1",
          ...
          id: "h4",
          name: "Doble carne y queso",
          price: 130,
          category: "Hamburguesa"
        }, {
          id: "o1",
          name: "Ciabatta de jamón o atún",
          price: 100,
          category: "Otros"
        }, {
          id: "o2",
          ...
          id: "bf9",
          name: "Agua de sabor emb.",
          price: 30,
          category: "Bebidas Frías"
        }, {
          id: "bf10",
          name: "Refresco 325 mL",
          price: 20,
          category: "Bebidas Frías"
        }, {
          id: "bf11",
        ...
        function App() {
          ...
          const addToOrder = product => {
            setOrder(prevOrder => {
              ...
              if (existingItem) {
                return prevOrder.map(item => item.product.id === product.id ? {
                  ...item,
          ...
          const exportToCSV = () => {
            ...
            const rows = filteredSales.map(sale => [new Date(sale.timestamp).toLocaleString("es-MX"), sale.id, sale.items.map(i => `${i.product.name} x${i.quantity}`).join("; "), sale.total]);
            ...
            link.download = `ventas-${reportPeriod}-${(/* @__PURE__ */new Date()).toISOString().split("T")[0]}.csv`;
            link.click();
          };
          const CategoryIcon = ({
            category
            ...
            switch (category) {
              case "Bebidas Calientes":
                return /* @__PURE__ */React.createElement(Coffee, {
                  className: "w-4 h-4"
                });
              case "Bebidas Frías":
                return /* @__PURE__ */React.createElement(IceCreamCone, {
                  className: "w-4 h-4"
                });
              case "Dulce Antojo":
                return /* @__PURE__ */React.createElement(IceCreamCone, {
              ...
              default:
                return /* @__PURE__ */React.createElement(Utensils, {
                  className: "w-4 h-4"
                });
            }
          };
          return /* @__PURE__ */React.createElement("div", {
          ...
          }, "Naynali Café"), /* @__PURE__ */React.createElement("p", {
            className: "text-sm text-gray-600"
          }, "Sistema POS"))), /* @__PURE__ */React.createElement("div", {
            className: "flex space-x-2"
          }, /* @__PURE__ */React.createElement("button", {
            onClick: () => setShowSales(!showSales),
            className: "p-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors"
          }, /* @__PURE__ */React.createElement(ChartBar, {
            className: "w-5 h-5"
          })), /* @__PURE__ */React.createElement("button", {
            onClick: () => setShowProductManager(!showProductManager),
            className: "p-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors"
          }, /* @__PURE__ */React.createElement(PenOff, {
            className: "w-5 h-5"
          }))))), showSales && /* @__PURE__ */React.createElement("div", {
            className: "bg-white rounded-2xl shadow-lg p-6 mb-6"
          }, /* @__PURE__ */React.createElement("div", {
            className: "flex items-center justify-between mb-4"
          }, /* @__PURE__ */React.createElement("h2", {
            className: "text-xl font-bold"
          }, "Reporte de Ventas"), /* @__PURE__ */React.createElement("button", {
            onClick: exportToCSV,
            ...
            className: "w-4 h-4"
          }), /* @__PURE__ */React.createElement("span", null, "Exportar CSV"))), /* @__PURE__ */React.createElement("div", {
            className: "flex space-x-2 mb-4"
          }, ["daily", "weekly", "monthly"].map(period => /* @__PURE__ */React.createElement("button", {
            key: period,
          ...
          }, period === "daily" ? "Hoy" : period === "weekly" ? "Semana" : "Mes"))), /* @__PURE__ */React.createElement("div", {
            className: "grid grid-cols-1 md:grid-cols-3 gap-4 mb-4"
          }, /* @__PURE__ */React.createElement("div", {
            className: "bg-green-100 p-4 rounded-lg"
          }, /* @__PURE__ */React.createElement("p", {
            className: "text-sm text-green-600"
          }, "Total Ventas"), /* @__PURE__ */React.createElement("p", {
            className: "text-2xl font-bold text-green-800"
          }, "$", filteredSales.reduce((sum, sale) => sum + sale.total, 0))), /* @__PURE__ */React.createElement("div", {
            className: "bg-blue-100 p-4 rounded-lg"
          }, /* @__PURE__ */React.createElement("p", {
            className: "text-sm text-blue-600"
          }, "Órdenes Completadas"), /* @__PURE__ */React.createElement("p", {
            className: "text-2xl font-bold text-blue-800"
          }, filteredSales.length)), /* @__PURE__ */React.createElement("div", {
            className: "bg-purple-100 p-4 rounded-lg"
          }, /* @__PURE__ */React.createElement("p", {
            className: "text-sm text-purple-600"
          }, "Promedio por Orden"), /* @__PURE__ */React.createElement("p", {
            className: "text-2xl font-bold text-purple-800"
          }, "$", filteredSales.length > 0 ? (filteredSales.reduce((sum, sale) => sum + sale.total, 0) / filteredSales.length).toFixed(2) : "0"))), /* @__PURE__ */React.createElement("div", {
            className: "max-h-64 overflow-y-auto"
          }, /* @__PURE__ */React.createElement("h3", {
            className: "font-semibold mb-2"
          }, "Transacciones Recientes"), filteredSales.slice(-10).reverse().map(sale => /* @__PURE__ */React.createElement("div", {
            key: sale.id,
            className: "flex justify-between items-center p-2 border-b"
          }, /* @__PURE__ */React.createElement("div", null, /* @__PURE__ */React.createElement("p", {
            className: "text-sm font-medium"
          }, new Date(sale.timestamp).toLocaleString("es-MX")), /* @__PURE__ */React.createElement("p", {
            className: "text-xs text-gray-600"
          }, sale.items.map(i => i.product.name).join(", "))), /* @__PURE__ */React.createElement("span", {
            className: "font-bold"
          }, "$", sale.total))))), showProductManager && /* @__PURE__ */React.createElement("div", {
            className: "bg-white rounded-2xl shadow-lg p-6 mb-6"
          }, /* @__PURE__ */React.createElement("h2", {
            className: "text-xl font-bold mb-4"
          }, "Gestión de Productos"), /* @__PURE__ */React.createElement("div", {
            className: "mb-4 p-4 bg-gray-50 rounded-lg"
          }, /* @__PURE__ */React.createElement("h3", {
            className: "font-semibold mb-2"
          }, "Agregar Nuevo Producto"), /* @__PURE__ */React.createElement("div", {
            ...
            value: ""
          }, "Categoría"), categories.map(cat => /* @__PURE__ */React.createElement("option", {
            key: cat,
            value: cat
          }, cat))), /* @__PURE__ */React.createElement("button", {
            onClick: handleAddProduct,
            className: "px-3 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors"
          }, /* @__PURE__ */React.createElement(ArrowBigRightDash, {
            className: "w-4 h-4 inline mr-1"
          }), " Agregar"))), /* @__PURE__ */React.createElement("div", {
            className: "max-h-64 overflow-y-auto"
          }, /* @__PURE__ */React.createElement("h3", {
            className: "font-semibold mb-2"
          }, "Productos Existentes"), menuData.map(product => /* @__PURE__ */React.createElement("div", {
            key: product.id,
            className: "flex items-center justify-between p-2 border-b"
          }, editingProduct?.id === product.id ? /* @__PURE__ */React.createElement(React.Fragment, null, /* @__PURE__ */React.createElement("input", {
            type: "text",
            ...
            className: `px-4 py-2 rounded-lg font-medium transition-all ${activeTab === category ? "bg-orange-500 text-white shadow-md" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`
          }, /* @__PURE__ */React.createElement("div", {
            className: "flex items-center space-x-2"
          }, /* @__PURE__ */React.createElement(CategoryIcon, {
            category
          }), /* @__PURE__ */React.createElement("span", null, category))))), /* @__PURE__ */React.createElement("div", {
            className: "grid grid-cols-2 md:grid-cols-3 gap-4"
          }, filteredProducts.map(product => /* @__PURE__ */React.createElement("button", {
            key: product.id,
          ...
          }), "Orden Actual"), /* @__PURE__ */React.createElement("span", {
            className: "text-sm text-gray-500"
          }, order.length, " items")), /* @__PURE__ */React.createElement("div", {
            className: "space-y-3 mb-4 max-h-96 overflow-y-auto"
          }, order.length === 0 ? /* @__PURE__ */React.createElement("p", {
            className: "text-center text-gray-500 py-8"
          }, "No hay items en la orden") : order.map(item => /* @__PURE__ */React.createElement("div", {
            key: item.product.id,
            ...
            className: "text-sm text-gray-600"
          }, "$", item.product.price, " c/u")), /* @__PURE__ */React.createElement("div", {
            className: "flex items-center space-x-2"
          }, /* @__PURE__ */React.createElement("button", {
          ...
          }, "$", orderTotal)), /* @__PURE__ */React.createElement("button", {
